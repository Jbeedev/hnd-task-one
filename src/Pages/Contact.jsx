...
const Contact = () => {
  return (
    <div className="mx-5 lg:mx-[360px] bg-white ">
      ...
      <form action="" className="w-full mt-7 flex gap-2 flex-col">
        ...
        <div className="flex gap-4 items-center ">
          ...
          />{" "}
          <p className="p-0 m-0">
            You agree to providing your data to <span className="font-semibold">Ajibade Ajibola </span>who may contact you
          </p>
        </div>
      </form>
      <button className="bg-blue-600 w-full py-3 mt-8 rounded-lg px-5 text-white">Send message</button>
    </div>
  );
};
